...
# הגדרות ה-API של GitLab (קריאה ציבורית של קבצים מהריפו שלך)
PROJECT_ID = "84191474"
...
try:
    ...
    <body>
        <div class="container">
            ...
            <div class="grid">
                <div class="card">
                    <div class="label">משתתפים שנרשמו</div>
                    <div class="number">{total_participants}</div>
                </div>
                <div class="card samples">
                    <div class="label">דגימות שנאספו (Feces)</div>
    ...
    # 4. שמירת הקובץ כ-index.html (דף הבית של הדשבורד)
